...
class FileManager:
    ...
    def addToStudentList(self, studentArr, fileToReadFrom):
        ...
        for student in file1.readlines():
            ...
            didPass = student[134:].strip()

            # current student's scores
            thisSubjects = []
            thisSubjects.append(self.makeSubject(student[45:56].strip()))
            thisSubjects.append(self.makeSubject(student[56:69].strip()))
            thisSubjects.append(self.makeSubject(student[69:82].strip()))
            thisSubjects.append(self.makeSubject(student[82:95].strip()))
            thisSubjects.append(self.makeSubject(student[95:108].strip()))
            thisSubjects.append(self.makeSubject(student[108:123].strip()))
    ...
    # def addToSubjectList(self, curSubjects):
    ...
    def createFormattedFiles(self, studentArr, fileCsv, fileSub):
        ...
        for s in studentArr:
            # read data from student list into master file
